...
def handle_request(request, rc):
    ...
    if ("request" in request):
        if request["request"] == "status":
            ...
            response = {"feed_rate":rc.controller.get_feed_speed(),"feed_rate_values":[100,200,500,1000,1500,2000],"move_time": rc.controller.get_move_duration(),"timelapse_time":rc.timelapse_time,"timelapse_steps":rc.timelapse_steps}
